...
export default function PostCard({ post }: Props) {
  ...
  return (
    <li
      key={post.id}
      className='flex flex-col border-[0.5px] border-dark-400 p-6 rounded-xl hover:border-dark-300 hover:brightness-150 hover:bg-dark-400/25 duration-200 ease-in-out'
    >
